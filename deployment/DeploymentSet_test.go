...
func createFakeDeploymentManager(
	...
	var deploymentManager = *NewDeploymentManager(
		crdReader, subscriberChan, cancellationChan, nil,
		nil, logr.Discard(),
	)
	deploymentManager.smfIntentProcessor = smfIntentProcessor
	deploymentManager.upfIntentProcessor = upfIntentProcessor
...
var _ = Describe(
	"ReportNFDeployEvent", func() {
		...
		var crdReader *crdreader.CRDSet
		var upfIntentProcessor *crdreader.UPFIntent
		var smfIntentProcessor *crdreader.SMFIntent
		var nfDeploy v1alpha1.NfDeploy
		BeforeEach(
			func() {
				crdReader = &crdreader.CRDSet{}
				nfDeploy = v1alpha1.NfDeploy{}
				upfIntentProcessor = &crdreader.UPFIntent{}
				smfIntentProcessor = &crdreader.SMFIntent{}
				deploymentManager = *createFakeDeploymentManager(
					crdReader, upfIntentProcessor, smfIntentProcessor,
				)
			...
			func() {
				It(
					"Should only update the existing deployment", func() {
						...
						deployment.smfIntentProcessor = deploymentManager.smfIntentProcessor
						deployment.upfIntentProcessor = deploymentManager.upfIntentProcessor
						deployment.crdReader = deploymentManager.crdReader
